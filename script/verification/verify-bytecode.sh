...
forge verify-bytecode --etherscan-api-key "$ETHERSCAN_API_KEY" "$ACCOUNTING_TOKEN_ADDRESS" AccountingToken:AccountingToken --constructor-args 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48 --rpc-url "$RPC_URL"
